...
if __name__ == '__main__':
	...
	plt.scatter(x_opt[0], x_opt[1], s = 20, label = 'x_opt')
	plt.plot(x, y_c0, '--', linewidth = 0.3, c = proj_cmap['blue'], label = 'c0')
	plt.plot(x, y_c1, '--', linewidth = 0.3, c = proj_cmap['orange'], label = 'c1')
