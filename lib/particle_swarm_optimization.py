...
class ParticalSwarmOptim(object):
	"""
	...
	@time_cost
	def optimize(self, w_decay = None, show_loss = False):
		"""
		执行粒子群优化
		...
		pso = ParticalSwarmOptim(objective, dim, iter_num, particles_num, dt, max_vel)
		...
		# 执行pso优化
		g_best_solution, g_best_value, (particles_locus_record, loss) = pso.optimize(w_decay = 0.99, show_loss = True)
		——————————————————
		"""
